...
const CocktailMoment = () => {
    ...
    const[cocktailData, fetchCocktailData] = useState<Cocktails[]>([])
      ...
      useEffect(()  => {
        const fetchData = async() => {
            ...
            const {data:cocktails, error} = await supabase.from('recipes').select('image, name, recipe,is_favorite,alt');
    ...
    return (
        ...
        <TouchableOpacity 
            ...
            <Image source={{uri:cocktail.image}} alt={cocktail.alt} style={StylesSame.imageCocktailCards}/>
